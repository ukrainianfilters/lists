...
> [!NOTE]
> Імпортовані списки фільтрів будуть оновлюватися автоматично, оскільки вони містять коментар `! Expires: 2 days` який задає інтервал автоматичного оновлення кожні 2 дні. У разі необхідності списки також можна оновлювати вручну.
